...
import com.example.chess.Model.Enums.Result;
import com.example.chess.Model.Enums.Tern;
...
public class PageGameMulti implements Initializable {
    @FXML
    ...
    private void showEndGame (Result result) {
        ...
        switch (result) {
            ...
            case Equal -> text.setText("The game equalised");
        }
...
//    check black mate
    ...
    private void checkMateBlack() {
        ...
        System.out.println("homes for black now : " + safeHomesForMate.size());
        if (safeHomesForMate.size() == 0) {
            onGame = true ;
            if (isBlackChecked()) {
